...
import 'package:engagely/app/core/widget/asset_image.dart';
...
class IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialSelectedCountry == null && number.startsWith('+')) {
      ...
      selectedCountry = widget.initialSelectedCountry ??
          _countryList.firstWhere((item) => item.code == 'US',
              orElse: () => _countryList.first);
      ...
      children: [
        ...
        Expanded(
          child: TextFormField(
            ...
            decoration: InputDecoration(hintText: strEnterPhoneNumber,hintStyle: widget.style,
            ...
            onChanged: (value) async {
              final phoneNumber = PhoneNumber(
                countryISOCode: selectedCountry.code,
                countryCode: '+${selectedCountry.fullCountryCode}',
                number: value,
              );
            ...
            validator: (value) {
              ...
              if (!widget.disableLengthCheck) {
                return value.length >= selectedCountry.minLength &&
            ...
            maxLength:
                widget.disableLengthCheck ? null : selectedCountry.maxLength,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.showCountryFlag) ...[
                  ...
                  //     ?
                  AssetImageWidget(
                    'lib/app/core/widget/intl_phone_field/assets/flags/${selectedCountry.code.toLowerCase()}.png',
