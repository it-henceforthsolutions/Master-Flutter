...
class OtherProfileController extends GetxController {
  ...
  void followUnfollowDialog() {
    Get.dialog(DialogWidget(image: iconsProfile,
      onAccepted: () {
  ...
  void offlineDialogShow() {
    Get.dialog(DialogWidget(
      ...
      isFailureButtonShow: false,imageHeight: height_120,imageWidth: margin_180,
      image: iconsOffline,
  ...
  void occupiedDialogShow() {
    Get.dialog( DialogWidget(
      ...
      image: iconsOccupied,imageHeight: height_100,imageWidth: margin_100,
