...
class LiveView extends GetView<LiveController> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Stack(
          children: [
            Obx(
              () => controller.state.value == typeTwoMember
                  ? _twoMemberJoinView()
                  : controller.state.value == typeThreeMember
                      ? _threeMemberJoinView()
                      : controller.state.value == typeFourMember
                          ? _fourMemberJoinView()
            ...
            Column(
              ...
              children: [
                _headerWidget(),
                Obx(() => controller.state.value == typeConnecting
                    ? emptySizeBox()
                    : Expanded(
                        child: controller.state.value == typeLive
                            ? emptySizeBox()
                            : _messageListView())),
                SizedBox(
                  height: height_10,
            ...
            Obx(() => controller.state.value == typeConnecting ||
                    controller.state.value == typeLive
                ? Align(
                    alignment: Alignment.center,
                    child: TextView(
                      maxLines: 4,
                      text: controller.state.value == typeConnecting
                          ? strInternetConnecting
                          : strLiveNow,
  ...
  Widget _twoMemberJoinView() => Column(
        children: [
          Expanded(
          ...
          Expanded(
            child: AssetImageWidget(iconsLiveTwo,
                imageWidth: Get.width,
                imageHeight: Get.height,
                imageFitType: BoxFit.cover),
          ),
  ...
  Widget _threeMemberJoinView() => Column(
        children: [
          Expanded(
            child: AssetImageWidget(iconsLive,
                imageWidth: Get.width,
  ...
  Widget _fourMemberJoinView() => Column(
        children: [
          Expanded(
            child: Row(
              children: [
  ...
  _headerWidget() => Column(
        children: [
          ...
          Get.arguments[isMyLive] == true ? _liveActions() : emptySizeBox(),
        ],
      );
  ...
  _messageListView() => ListView.builder(
      ...
      itemBuilder: (context, index) =>
          const CommentItemView().marginOnly(top: margin_5));
  ...
  _inviteUserButton() => ButtonWidget(
        onTap: () {
