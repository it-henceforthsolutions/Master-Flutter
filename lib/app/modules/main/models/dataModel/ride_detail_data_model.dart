...
class RideDetailDataModel {
  ...
  RideDetailDataModel({this.id, this.title, this.pickup, this.destination,
    this.pickupLat, this.pickupLong, this.destinationLat, this.destinationLong, this.driverId,
    this.carTypeId, this.startTime, this.endTime, this.totalMin, this.waitingTime, this.totalKm,
    this.scheduleTime, this.paymentType, this.paymentStatus, this.reason, this.stateId,
    this.typeId, this.createdOn, this.createdById, this.invoiceUrl, this.otp, this.otpVerified,
    this.stops});

  RideDetailDataModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    pickup = json['pickup'];
